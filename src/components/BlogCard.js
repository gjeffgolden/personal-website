...
export default function BlogCard({ headline, teaser, wordpress }) {
    ...
    return (
            <Link underline="none" href={wordpress} target="_blank" style={{display: 'flex', flexFlow: 'column', alignItems: "center", width: "100%"}}>
                <Card onClick={handleClick} style={{display: "flex", height: '75px', width: "90%", backgroundColor: "rgb(255, 255, 255, 0.7"}}>
                    <CardContent style={{display: "flex", flexFlow: "row", width: "100%", justifyContent: "space-between", alignItems: "center"}}>
