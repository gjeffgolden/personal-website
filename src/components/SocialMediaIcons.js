...
export default function SocialMediaIcons() {
    return (
        <Container maxWidth="md" disableGutters={true} style={{display: 'flex', flexFlow: 'row', justifyContent: 'center'}}>
            <Link href="https://www.linkedin.com/in/gjeffgolden/" target="_blank" style={{padding: '0.1rem'}}>
                <Avatar className="social-icon" alt="LinkedIn Icon" src={LinkedIn}/>
            </Link>
            <Link href="https://github.com/gjeffgolden" target="_blank" style={{padding: '0.1rem'}}>
                <Avatar className="social-icon" alt="GitHub Icon" src={GitHub}/>
            </Link>
            <Link href="https://www.instagram.com/gjeffgolden/" target="_blank" style={{padding: '0.1rem'}}>
                <Avatar className="social-icon" alt="Instagram Icon" src={Instagram}/>
            </Link>
            <Link href="https://www.twitter.com/gjeffgolden/" target="_blank" style={{padding: '0.1rem'}}>
