...
export default function Home() {
    return (
        <Container className="main-container" maxWidth="md" style={{height: '70vh', width: "100%", display: 'flex', flexFlow: 'column', justifyContent: 'flex-end', marginLeft: '6rem', minHeight: '26rem'}}>
