...
export default function FunFacts() {
    ...
    const facts = [
        ...
        "I'm an active freelance adventure journalist with recent bylines in Outside magazine, 5280 magazine and the Osprey Packs blog.", 
        "My dog is a champion dock-diver and competes annually in the GoPro Mountain Games.",
        "I'm a fan of classic PC and console games. You're more likely to find me playing the original Diablo than Cyberpunk.",
